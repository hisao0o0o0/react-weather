...
class WeatherPage extends Component {
    constructor(props) {
        ...
        this.OpenWeatherMapKey = process.env.API_KEY
    }
        ...
        return (
            <MuiThemeProvider>
                <Card style={{margin: 30}}>
                    ...
                    <CardActions>
                        <PlaceSelector places={this.Places} actionSlect={ix=>this.selectPlace(ix)} />
                    </CardActions>
                </Card>
            </MuiThemeProvider>
        )
...
const PlaceSelector = props => (
    <DropDownMenu value={-1} onChange={(event, index) => props.actionSlect(index)}>
